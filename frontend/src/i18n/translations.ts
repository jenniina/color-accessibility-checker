export const translations = {
  ...
  YouMayLogInToTheseSitesWithTheSameCredentials: {
    en: 'You may log in to these sites with the same credentials',
    es: 'Puedes iniciar sesión en estos sitios con las mismas credenciales',
    fr: 'Vous pouvez vous connecter à ces sites avec les mêmes identifiants',
    de: 'Sie können sich bei diesen Seiten mit denselben Anmeldeinformationen anmelden',
    pt: 'Você pode fazer login nesses sites com as mesmas credenciais',
    cs: 'Můžete se přihlásit na tyto stránky se stejnými přihlašovacími údaji',
    fi: 'Voit kirjautua näille sivustoille samoilla tunnuksilla',
  },
  JenniinasReactPortfolio: {
    en: "Jenniina's React portfolio",
    es: 'Portafolio de React de Jenniina',
    fr: 'Portefeuille React de Jenniina',
    de: 'Jenniinas React-Portfolio',
    pt: 'Portfólio React da Jenniina',
    cs: 'React portfolio od Jenniiny',
    fi: 'Jenniinan React-portfolio',
  },
  BlobArtApp: {
    en: 'Blob Art App',
    es: 'Aplicación de arte de blobs',
    fr: "Application d'art de blobs",
    de: 'Blob-Kunst-App',
    pt: 'Aplicativo de Arte de Blobs',
    cs: 'Aplikace Blob Art',
    fi: 'Mollukkataide-sovellus',
  },
  ...
  JokeAppWithCustomizableOptions: {
    en: 'A joke app with customizable options',
    es: 'Una aplicación de chistes con opciones personalizables',
    fr: 'Une application de blagues avec des options personnalisables',
    de: 'Eine Witze-App mit anpassbaren Optionen',
    pt: 'Um aplicativo de piadas com opções personalizáveis',
    cs: 'Aplikace vtipů s možnostmi přizpůsobení',
    fi: 'Vitsisovellus, jossa on muokattavia vaihtoehtoja',
  },
  YouMaySaveYourFavoriteJokesOrAddYourOwn: {
    ...
    fr: 'Vous pouvez enregistrer vos blagues préférées ou ajouter les vôtres lorsque vous êtes connecté.',
    de: 'Sie können Ihre Lieblingswitze speichern oder eigene hinzufügen, wenn Sie eingeloggt sind.',
    pt: 'Você pode salvar suas piadas favoritas ou adicionar as suas próprias quando estiver logado.',
    cs: 'Můžete uložit své oblíbené vtipy nebo přidat své vlastní, když jste přihlášeni.',
    fi: 'Voit tallentaa suosikkivitsisi tai lisätä omiasi, kun olet kirjautunut sisään.',
  },
  BlobAppIntro: {
    en: 'A custom draggables app with blobs that meld into each other.',
    es: 'Una aplicación personalizada de elementos arrastrables con blobs que se fusionan entre sí.',
    fr: "Une application personnalisée d'éléments glissables avec des blobs qui se fondent les uns dans les autres.",
    de: 'Eine benutzerdefinierte Drag & Drop-App mit Blobs, die ineinander übergehen.',
    pt: 'Um aplicativo personalizado de arrastáveis com blobs que se fundem entre si.',
  ...
  PortfolioIntro: {
    en: 'Contains, among other things, a memory game and a quiz game and links to other projects by Jenniina.',
    es: 'Contiene, entre otras cosas, un juego de memoria y un juego de preguntas y respuestas, así como enlaces a otros proyectos de Jenniina.',
    fr: "Contient, entre autres, un jeu de mémoire et un jeu de quiz, ainsi que des liens vers d'autres projets de Jenniina.",
    de: 'Enthält unter anderem ein Memory-Spiel und ein Quiz-Spiel sowie Links zu anderen Projekten von Jenniina.',
    pt: 'Contém, entre outras coisas, um jogo de memória e um jogo de quiz, além de links para outros projetos de Jenniina.',
    cs: 'Obsahuje mimo jiné hru na paměť a kvízovou hru a odkazy na další projekty od Jenniina.',
    fi: 'Sisältää muun muassa muistipelin ja tietovisapelin sekä linkkejä Jenniinan muihin projekteihin.',
  },
  DontAskMeAgain: {
  ...
  BadFit: {
    en: 'Bad fit',
    es: 'Mala combinación',
    fr: 'Mauvaise combinaison',
    de: 'Schlechte Kombination',
    pt: 'Má combinação',
    cs: 'Špatná kombinace',
    fi: 'Huono yhdistelmä',
  },
  ...
  BestFit: {
    ...
    de: 'Beste Passform',
    pt: 'Melhor ajuste',
    cs: 'Nejlepší přizpůsobení',
    fi: 'Paras sopivuus',
  },
  TheRoundFilledIndicator: {
    en: 'The big filled round indicator marks the highest AAA-compatibility for small text',
    es: 'El indicador redondo grande relleno marca la mayor compatibilidad AAA para texto pequeño',
    fr: 'Le grand indicateur rond rempli marque la plus haute compatibilité AAA pour le petit texte',
    de: 'Der große gefüllte runde Indikator kennzeichnet die höchste AAA-Kompatibilität für kleinen Text',
    pt: 'O grande indicador redondo preenchido marca a maior compatibilidade AAA para texto pequeno',
    cs: 'Velký plný kulový indikátor označuje nejvyšší kompatibilitu AAA pro malý text',
    fi: 'Suuri täytetty pyöreä indikaattori merkitsee korkeinta AAA-yhteensopivuutta pienelle tekstille',
  },
  SmallTextNeedsAtLeastAACompliance: {
    en: 'Small text needs at least AA-compliance',
    es: 'El texto pequeño necesita al menos compatibilidad AA',
    fr: 'Le petit texte a besoin d au moins une conformité AA',
    de: 'Kleiner Text benötigt mindestens AA-Konformität',
    pt: 'O texto pequeno precisa de pelo menos compatibilidade AA',
    cs: 'Malý text potřebuje alespoň shodu AA',
    fi: 'Pieni teksti tarvitsee vähintään AA-yhteensopivuuden',
  },
  MinimumCompatibilityForSmallText: {
    en: 'Minimum compatibility for small text',
    es: 'Compatibilidad mínima para texto pequeño',
    fr: 'Compatibilité minimale pour le petit texte',
    de: 'Minimale Kompatibilität für kleinen Text',
    pt: 'Compatibilidade mínima para texto pequeno',
    cs: 'Minimální kompatibilita pro malý text',
    fi: 'Vähimmäisyhteensopivuus pienelle tekstille',
  },
  TheRoundHollowIndicator: {
    en: 'The hollow round indicator marks AA-compatibility for small text',
    es: 'El indicador redondo hueco marca la compatibilidad AA para texto pequeño',
    fr: 'L indicateur rond creux marque la compatibilité AA pour le petit texte',
    de: 'Der hohle runde Indikator kennzeichnet die AA-Kompatibilität für kleinen Text',
    pt: 'O indicador redondo oco marca a compatibilidade AA para texto pequeno',
    cs: 'Dutý kulový indikátor označuje kompatibilitu AA pro malý text',
    fi: 'Ontto pyöreä indikaattori merkitsee AA-yhteensopivuutta pienelle tekstille',
  },
  ...
  OnlyUIAndOther: {
    en: 'Only UI and other graphical elements',
    es: 'Solo la interfaz de usuario y otros elementos gráficos',
    fr: "Uniquement l'interface utilisateur et d'autres éléments graphiques",
    de: 'Nur die Benutzeroberfläche und andere grafische Elemente',
    pt: 'Apenas a interface do usuário e outros elementos gráficos',
    cs: 'Pouze uživatelské rozhraní a další grafické prvky',
    fi: 'Vain käyttöliittymä ja muut graafiset elementit',
  },
  OnlyUI: {
  ...
  AlreadyOnFirstPage: {
    en: 'Already on the first page',
    es: 'Ya estás en la primera página',
    fr: 'Déjà sur la première page',
    de: 'Bereits auf der ersten Seite',
    pt: 'Já está na primeira página',
    cs: 'Již jste na první stránce',
    fi: 'Olet jo ensimmäisellä sivulla',
  },
  AlreadyOnLastPage: {
    en: 'Already on the last page',
    es: 'Ya estás en la última página',
    fr: 'Déjà sur la dernière page',
    de: 'Bereits auf der letzten Seite',
    pt: 'Já está na última página',
    cs: 'Již jste na poslední stránce',
    fi: 'Olet jo viimeisellä sivulla',
  },
  GetInTouch: {
    en: 'Get in touch',
